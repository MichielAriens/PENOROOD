...
# Find the blobs in a given picture
image = Image('C:\Users\Babyburger\Desktop\whiteshapes.jpg')
...
rectangles = next(b for b in blobs if b.isRectangle(rectangleTolerance))  # find all the rectangles within a certain tolerance
